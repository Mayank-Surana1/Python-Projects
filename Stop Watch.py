...
minutes = (Elapsed_time % 3600) // 60  #after calculating hours, the remaining seconds are calculated using the modulus operator (%), and then divided by 60 to get the number of minutes in the elapsed time.
